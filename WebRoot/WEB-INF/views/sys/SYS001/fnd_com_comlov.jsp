...
<body> 
	...
	data-options="
			     ...
			     singleSelect: true,
			     method: 'get',
			     url:'ToDoGo.do?actionId=query@fnd_com&dataSorce=xml/sys/SYS001/fnd_company_lov.xml',
			     onDblClickRow: function (index, data) {
	        	   $('#com_lov_id')._setLovdata(data);
            	   $('#com_lov_id').window('close');  
	             }
				">
		        <thead>
		            <tr>
		             <th data-options="field:'company_id',checkbox:true">company_id</th>
				     <th data-options="field:'company_code',width:100,editor:'text'">公司代码代码</th>
					 <th data-options="field:'company_short_name',width:100,editor:'text'">公司简称</th>
		            </tr>
		        </thead>
		    </table> 
 <script type="text/javascript">
    ...
    var this_window_id='#edit_test_open1';
    var lov_url_e12='ToDoGo.do?actionId=query@fnd_com&dataSorce=xml/sys/SYS001/fnd_company_lov.xml';
/* $(function () {
	    lov_record="";
	    var alert_flaglov=0;
 ...
 function lov_querye12(val){
   ...
   function lov_confirm12(){
	   ...
	   $('#com_lov_id')._setLovdata(records);
  	   $('#com_lov_id').window('close');  
 }
  //**end edit lovcombox************************************************************************// 
</script>    
